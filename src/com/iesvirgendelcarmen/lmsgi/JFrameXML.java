...
public class JFrameXML extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldXPath.setText("Expresión XPath");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        jFileChooserXML.setFileFilter(filterXML); // ESTO ES LO QUE SE VA CAMBIANDO SEGÚN LO QUE QUERAMOS
    ...
    private void jButtonValidarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonValidarActionPerformed
        // tengo que ponerle de nombre "boton VALIDAR XML" en la pestaña "validar DTD"
        
        // vamos a "Validar" a través del Controller
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // nos aseguramos primero que no sea vacío (que haya texto)
        if(!jTextFieldXPath.getText().isEmpty()) {
            jTextAreaResultadoXPath.setText(controller.xPathEvaluate(jTextFieldXPath.getText()));
        }
    ...
    private void jButtonCargarDTDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCargarDTDActionPerformed
        jFileChooserXML.setFileFilter(filterDTD); // ESTO ES LO QUE SE VA CAMBIANDO SEGÚN LO QUE QUERAMOS
